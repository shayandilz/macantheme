<div class="search-box position-relative w-100 mx-auto mt-5">
    ...
    <input class="z-2 position-absolute w-100 h-100 end-0 top-0 text-danger bg-transparent border-0" type="text" placeholder="عبارت مورد نظرتان را تایپ کنید ..." id="search-input">
