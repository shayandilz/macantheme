        ...
        <form id="commentform" method="post" action="<?= get_option('siteurl') ?>/wp-comments-post.php">
            <div class="row gx-1 gy-4">
                ...
                <?php if (!is_user_logged_in()) { ?>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-floating">
                            ...
                            <label class="ps-4"  for="name">نام و نام خانوادگی</label>
                        </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-floating">
                            <input id="email" type="text" placeholder="ایمیل" name="email"
                                   class="form-control rounded-0" required="">
                            <label class="ps-4"  for="email">ایمیل</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                                        <textarea id="message" placeholder="پیام..." rows="10" name="comment"
                                                  class="form-control rounded-0" required=""></textarea>
                            <label class="ps-4"  for="message">پیام...</label>
                        </div>
                    </div>
                ...
                <div class="mt-4 d-flex justify-content-end">
                    <button type="submit" class="btn btn-danger d-flex align-items-center rounded-0">ثبت نظر
